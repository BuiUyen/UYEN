...
namespace Sanita.Utility.UI
{
    ...
    internal class AutocompleteMenuHost : ToolStripDropDown
    {
        ...
        public IAutocompleteListView ListView
        {
            ...
            set
            {
                ...
                if (listView != null)
                {
                    ...
                    (listView as Control).MouseWheel -= new MouseEventHandler(ListView_MouseWheel);
                }
        ...
        void ListView_MouseWheel(object sender, MouseEventArgs e)
        {
            (ListView as AutocompleteListView).DoScroll(e.Delta);
        }
