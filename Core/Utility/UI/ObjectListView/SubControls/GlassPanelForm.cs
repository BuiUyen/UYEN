...
namespace Sanita.Utility.UI
{
    ...
    internal partial class GlassPanelForm : Form
    {
        ...
        public void Bind(ObjectListView olv, IOverlay overlay) {
            ...
            if (this.Owner != null) {
                ...
                if (this.mdiOwner != null) {
                    ...
                    // Find the MDIClinic control, which houses all MDI children
                    foreach (Control c in this.mdiOwner.Controls) {
                        this.mdiClinic = c as MdiClient;
                        if (this.mdiClinic != null) {
                            break;
                        }
                    }
                    if (this.mdiClinic != null) {
                        this.mdiClinic.ClientSizeChanged += new EventHandler(myMdiClinic_ClientSizeChanged);
                    }
                }
            }
        ...
        void myMdiClinic_ClientSizeChanged(object sender, EventArgs e) {
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            if (this.mdiClinic != null) {
                Rectangle r = mdiClinic.RectangleToScreen(mdiClinic.ClientRectangle);
