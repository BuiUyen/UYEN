...
namespace Sanita.Utility.UI
{
    ...
    public partial class ObjectListView
    {
        ...
        //++Added by KhoiVV 20101003
        /// <summary>
        /// 
        /// </summary>
        [Category("Behavior - ObjectListView"),
        Description("This event is triggered when have char is input to list.")]
        public event EventHandler<KeyPressEventArgs> PutCharData;

        protected virtual void OnPutCharData(char keychar)
        {
            if (this.PutCharData != null)
            {
                KeyPressEventArgs e = new KeyPressEventArgs(keychar);
                this.PutCharData(this, e);
            }
        }
        //--Added by KhoiVV 20101003

        //++Added by KhoiVV 20180417
        /// <summary>
        /// 
        /// </summary>
        [Category("Behavior - ObjectListView"),
        Description("This event is triggered when have char is input to list.")]
        public event EventHandler<EventArgs> PutMouseData;

        protected virtual void OnPutMouseData()
        {
            if (this.PutMouseData != null)
            {
                EventArgs e = new EventArgs();
                this.PutMouseData(this, e);
            }
        }
        //--Added by KhoiVV 20180417
