...
namespace Sanita.Utility.UI {
    ...
    public class FilterMenuBuilder {
        ...
        /// Exposed so it can be localized.
        /// </summary>
        static public string SELECT_ALL_LABEL = "Chọn Tất Cả";
        //--Update text by KhoiVV

        /// <summary>
        /// Gets or sets the image that will be placed next to the Clear Filtering menu item
        /// </summary>
        static public Bitmap ClearFilteringImage = MediboxAssistant.Properties.Resources.ClearFiltering;

        /// <summary>
        /// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
        /// </summary>
        static public Bitmap FilteringImage = MediboxAssistant.Properties.Resources.Filtering;
