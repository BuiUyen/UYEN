...
namespace Sanita.Utility.UI
{
    ...
    {
        //++Added by KhoiVV
        public bool isUseNoneVietNamese = true;
        //--Added by KhoiVV
        ...
        public IEnumerable<string> ContainsStrings
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    {
                        if (!String.IsNullOrEmpty(text.Trim()) && text.Length >= 2)
                        {
                            if (listView.isSearchWholeText)
                            {
                                this.MatchingStrategies.Add(new TextContainsMatchingStrategy(this, text.Trim()));
                            }
                            else
                            {
                                this.MatchingStrategies.Add(new TextBeginsMatchingStrategy(this, text.Trim()));
                            }
                        }
                    }
                    //--Update by KhoiVV
