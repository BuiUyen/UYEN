...
namespace Sanita.Utility.UI
{
    ...
    /// </remarks>
    [Browsable(false)]
    //++Added by KhoiVV 20130129
    [Serializable()]
    //--Added by KhoiVV 20130129
    public partial class OLVColumn : ColumnHeader
    {

        //++Added by KhoiVV - 2017-02-23
        public bool IsStatusColumn = false;
        //--Added by KhoiVV - 2017-02-23
        ...
        public string ValueToString(object value)
        {
            ...
            //++Added by KhoiVV 20110215
            {
                //Xu ly khi format string -> number
                if (value is string)
                {
                    int number = 0;
