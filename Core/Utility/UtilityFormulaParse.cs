...
namespace Sanita.Utility
{
    #region RPN
    /// <summary>
    /// Summary description for FormulaParse.
    /// </summary>
    public class UtilityFormulaParse
    {
        public UtilityFormulaParse()
        {
        }
    ...
    public class ArithmeticOperator : Operator
    {
        ...
        public override IOperand Eval(IOperand lhs, IOperand rhs)
        {
            ...
            switch (m_szOperator)
            {
                ...
                case "^":
                    return ((IArithmeticOperations)lhs).Power(rhs);
            }
